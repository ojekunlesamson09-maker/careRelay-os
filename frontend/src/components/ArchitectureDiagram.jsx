    ...
    <div className="py-12 sm:py-16 px-4 sm:px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3">System Architecture</h2>
          <p className="text-gray-500 text-sm sm:text-base">How CareRelay OS connects EHR data to verified clinical handoffs</p>
        </div>

        <div className="bg-gray-950 rounded-2xl p-4 sm:p-8 overflow-x-auto">
          <div className="min-w-[320px] mx-auto flex flex-col items-center gap-3">

            {/* EHR */}
            <div className="bg-blue-900 border-2 border-blue-400 rounded-xl px-6 sm:px-8 py-3 sm:py-4 text-center w-full max-w-xs">
              <p className="text-2xl mb-1">🏥</p>
              <p className="text-white font-black text-sm">EHR System</p>
            ...
            {/* FHIR */}
            <div className="bg-purple-900 border-2 border-purple-400 rounded-xl px-6 sm:px-8 py-3 sm:py-4 text-center w-full max-w-xs">
              <p className="text-2xl mb-1">📊</p>
              <p className="text-white font-black text-sm">FHIR R4 API</p>
            ...
            {/* Gateway */}
            <div className="bg-yellow-900 border-2 border-yellow-400 rounded-xl px-6 sm:px-8 py-3 sm:py-4 text-center w-full max-w-xs">
              <p className="text-2xl mb-1">🔌</p>
              <p className="text-white font-black text-sm">Node.js API Gateway</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 w-full">
              {[
                ...
                <div key={i} className={`${agent.bg} border-2 ${agent.border} rounded-xl p-3 text-center`}>
                  ...
                  {i < 3 && <p className="text-purple-400 text-xs mt-1 hidden sm:block">→ A2A →</p>}
                </div>
              ))}
            </div>
            ...
            {/* Verified Output */}
            <div className="bg-green-900 border-2 border-green-400 rounded-xl px-6 py-3 text-center w-full max-w-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
              <div className="bg-blue-950 border-2 border-blue-300 rounded-xl px-4 py-3 text-center">
              ...
              <div className="bg-gray-900 border-2 border-gray-500 rounded-xl px-4 py-3 text-center">
